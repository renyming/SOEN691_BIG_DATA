...
| ---------------- | ------------------------------------------------------- | 
| Original dataset | <img src="report_pics/correlations-train.png"  width="60%">          | 
| Preprocessed dataset | <img src="report_pics/correlations-train-clean.png"  width="60%">|
...
any data point that fall outside of either <i>1.5 times the IQR below the first 
quartile</i> or <i>1.5 times the IQR above the third quartile</i> to be “outliers”. 
